...
# --------------------------------
path_root="./resource/"
cascade_path = path_root+'/model/lbpcascade_animeface.xml'
input_path = path_root+'/Images/input.png'
output_path = path_root+'/Images/output.png'
failure_path = path_root+'/images/failure.png'
resize_lenght = 280
print("is Exit cascade? : ",os.path.exists(cascade_path))
# --------------------------------
